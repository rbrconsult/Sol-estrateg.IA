...
const CRON_JOBS = [
  { schedule: "*/5 * * * *", interval: "5 min", function: "cron-sync", tables: "sol_projetos, sol_qualificacao_sync, sol_conversions_sync, make_heartbeat, make_errors", note: "Dados operacionais em tempo quase-real" },
...
const SYNC_TABLES = [
  { table: "sol_projetos", ds_make: "sol_leads (87418)", records: "~16", mode: "READ", sync: "5 min", purpose: "Leads do Agente SDR SOL" },
