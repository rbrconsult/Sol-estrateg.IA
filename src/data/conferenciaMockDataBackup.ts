// ══════════════════════════════════════════════════════════
// DADOS ORIGINAIS — BACKUP (antes das mudanças no funil/origens)
...
// ─── FUNIL DE LEADS (sequência original sem DESQUALIFICADOS) ───
...
// ─── INSIGHTS ESTRATÉGICOS (com menção BANT original) ───
export const insights = [
  ...
  },
  {
    ...
    description: "284 leads qualificados com 100% dos dados inseridos no CRM automaticamente via BANT. Decisões baseadas em dados, não suposições.",
  },
];
...
// ─── ORIGEM DOS LEADS (6 entradas originais separadas) ───
