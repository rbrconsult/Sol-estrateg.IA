...
/** @deprecated v1 syncDataStore — removed, use syncSolLeads instead */
async function syncDataStore(_supabase: any, _creds: OrgCredentials): Promise<any> {
  return { skipped: true, reason: 'v1 deprecated — use syncSolLeads' };
}

/** @deprecated v1 syncComercialDS — removed, data comes from sol_leads_sync.closer_nome */
async function syncComercialDS(_supabase: any, _creds: OrgCredentials): Promise<any> {
  return { skipped: true, reason: 'v1 deprecated — comercial data in sol_leads_sync' };
}
